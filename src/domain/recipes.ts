...
export const RECIPES: Recipe[] = [
  ...
  recipe("kimchi-geotjeori", "김치겉절이", "한식", 5, ["kimchi"], [
    item("김치", 100, "g"),
    item("참기름", 1, "작은술", true),
    item("마늘", 0.5, "쪽", true),
  ], [
    "김치를 한입 크기로 잘라 참기름에 무친다.",
  ]),
  recipe("pa-bokkeum", "대파볶음", "한식", 8, ["green-onion"], [
    item("대파", 80, "g"),
    item("식용유", 1, "큰술", true),
    item("간장", 1, "작은술", true),
  ], [
    "대파를 어슷 썰어 기름에 볶아 간장으로 간한다.",
  ]),
  recipe("onion-bokkeum", "양파볶음", "한식", 10, ["onion"], [
    item("양파", 1, "개"),
    item("식용유", 1, "큰술", true),
    item("간장", 1, "작은술", true),
  ], [
    "양파를 채 썰어 투명해질 때까지 볶는다.",
  ]),
  recipe("beef-gui", "소고기구이", "한식", 12, ["beef"], [
    item("소고기", 120, "g"),
    item("소금", 1, "꼬집", true),
    item("후추", null, "조금", true),
  ], [
  ...
  recipe("bacon-gui", "베이컨구이", "한식", 8, ["bacon"], [
    item("베이컨", 60, "g"),
  ], [
    "팬에 베이컨을 바삭하게 굽는다.",
  ]),
  recipe("ham-gui", "햄구이", "한식", 8, ["ham"], [
    item("햄", 80, "g"),
  ], [
    "햄을 팬에 앞뒤로 굽는다.",
  ]),
  recipe("sausage-gui", "소시지구이", "한식", 10, ["sausage"], [
    item("소시지", 80, "g"),
  ], [
    "소시지에 칼집을 내어 팬에 굴리며 굽는다.",
  ]),
  recipe("ssam-geotjeori", "상추겉절이", "한식", 8, ["lettuce"], [
    item("상추", 60, "g"),
    item("고추장", 1, "작은술", true),
    item("식초", 1, "작은술", true),
  ], [
    "상추를 한입 크기로 뜯어 고추장·식초에 가볍게 무친다.",
  ]),
  recipe("ganjang-bap", "간장밥", "한식", 3, ["rice"], [
    item("밥", 1, "공기"),
    item("간장", 1, "작은술", true),
    item("참기름", 1, "작은술", true),
  ], [
    "뜨거운 밥에 간장과 참기름을 둘러 비빈다.",
  ]),
  recipe("tuna-muchim", "참치무침", "한식", 5, ["tuna"], [
    item("참치캔", 1, "캔"),
    item("참기름", 1, "작은술", true),
    item("소금", 1, "꼬집", true),
  ], [
  ...
  recipe("ojingeo-gui", "오징어구이", "한식", 10, ["squid"], [
    item("오징어", 150, "g"),
    item("소금", 1, "꼬집", true),
    item("식용유", 1, "작은술", true),
  ], [
    "오징어를 한입 크기로 잘라 소금만 뿌려 짧게 굽는다.",
  ]),
  recipe("shrimp-gui", "새우구이", "한식", 8, ["shrimp"], [
    item("새우", 100, "g"),
    item("소금", 1, "꼬집", true),
  ], [
    "새우에 소금을 뿌려 팬에 굽는다.",
  ]),
  recipe("bread-toast", "식빵구이", "집양식", 5, ["bread"], [
    item("식빵", 2, "장"),
  ], [
    "식빵을 팬이나 토스터에 노릇하게 굽는다.",
  ]),
  recipe("butter-toast", "버터토스트", "집양식", 6, ["bread", "butter"], [
    item("식빵", 2, "장"),
    item("버터", 10, "g"),
  ], [
    "식빵에 버터를 발라 팬에서 굽는다.",
  ]),
  recipe("egg-toast", "계란토스트", "집양식", 10, ["bread", "egg"], [
    item("식빵", 2, "장"),
    item("계란", 1, "개"),
    item("버터", 5, "g"),
  ], [
    "식빵을 굽고 그 위에 계란후라이를 올린다.",
  ]),
  recipe("cheese-bread", "치즈식빵", "집양식", 8, ["bread", "cheese"], [
    item("식빵", 2, "장"),
    item("치즈", 1, "장"),
  ], [
    "식빵 사이에 치즈를 넣고 치즈가 녹을 때까지 굽는다.",
  ]),
  recipe("milk-toast", "우유토스트", "집양식", 8, ["bread", "milk"], [
    item("식빵", 2, "장"),
    item("우유", 40, "ml"),
    item("버터", 5, "g"),
  ], [
    "식빵에 우유를 살짝 적셔 팬에 굽는다.",
  ]),
  recipe("garlic-pasta", "마늘파스타", "집양식", 15, ["spaghetti"], [
    item("파스타면", 80, "g"),
    item("마늘", 3, "쪽", true),
    item("식용유", 2, "큰술", true),
    item("소금", 1, "꼬집", true),
  ], [
    "기름에 마늘 향을 내고 삶은 면을 넣어 버무린다.",
  ]),
  recipe("pan-cheese", "팬치즈구이", "집양식", 8, ["cheese"], [
    item("치즈", 2, "장"),
  ], [
    "팬에 치즈를 올려 가장자리만 바삭하게 녹인다.",
  ]),
  recipe("tomato-gui", "토마토구이", "집양식", 8, ["tomato"], [
    item("토마토", 1, "개"),
    item("소금", 1, "꼬집", true),
    item("식용유", 1, "작은술", true),
  ], [
    "토마토를 반으로 갈라 소금을 뿌려 팬에 굽는다.",
  ]),
  recipe("milk-soup", "우유수프", "집양식", 10, ["milk"], [
    item("우유", 250, "ml"),
    item("소금", 1, "꼬집", true),
    item("후추", null, "조금", true),
  ], [
    "우유를 약한 불에서 데워 소금·후추로 간한다.",
  ]),
  recipe("butter-bap", "버터밥", "집양식", 5, ["rice", "butter"], [
    item("밥", 1, "공기"),
    item("버터", 10, "g"),
    item("소금", 1, "꼬집", true),
  ], [
    "뜨거운 밥에 버터를 넣어 녹여 가며 섞는다.",
  ]),
  recipe("garlic-butter", "마늘버터", "집양식", 5, ["butter"], [
    item("버터", 15, "g"),
    item("마늘", 2, "쪽", true),
    item("소금", 1, "꼬집", true),
  ], [
    "팬에 버터를 녹여 마늘을 볶는다. 밥이나 식빵에 발라 먹는다.",
  ]),
];
